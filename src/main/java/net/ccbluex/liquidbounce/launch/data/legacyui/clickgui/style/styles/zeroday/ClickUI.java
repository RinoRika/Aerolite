...
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.zeroday.Window;
...
public class ClickUI extends GuiScreen {
    ...
    public ClickUI(){
        ...
        try {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream(LiquidBounce.INSTANCE.getFileManager().getSpecialConfig() + "\\clickgui.txt")));
            String line;
    ...
    public void onGuiClosed() {
        try {
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(LiquidBounce.INSTANCE.getFileManager().getSpecialConfig() + "\\clickgui.txt")));
            for (Window window : windows){
