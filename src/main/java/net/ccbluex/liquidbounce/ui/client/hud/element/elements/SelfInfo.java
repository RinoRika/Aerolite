...
public class SelfInfo extends Element {
    ...
    public Border drawElement(float partialTicks) {
        ...
        Fonts.font30.drawString("Indicators", xX + 37, yX + 202 - 406, -1);
        ...
        Fonts.font30.drawString("Armor", xX + 8, yX + 211 - 406, -1);
        ...
        Fonts.font30.drawString("HurtTime", xX + 8, yX + 220 - 406, -1);
        ...
        Fonts.font30.drawString("BPS", xX + 8, yX + 229 - 406, -1);
        ...
        Fonts.font30.drawString("HP", xX + 8, yX + 238 - 406, -1);
        return new Border(0,-8,98,39);
    }
