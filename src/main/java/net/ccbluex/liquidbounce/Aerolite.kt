...
class Aerolite {
    ...
    companion object {
        ...
        val titles = arrayOf("有的人天天笑别人，却不知道自己就是个笑话", "一边议论别人一边卖惨自己，有比这更可笑的吗？", "玩方块人时,淳哥总是注入Vape",
            ...
            "Stop copy this: 豪弟弟:帮我拉aerolite bmc参", "谁是0?", "拼写错误: 在单词 '***' 中", "Stop copy this: 我能不回答吗；；", "Stop copy this: blockman3063:为什么没有释放在github",
            "这是我在华军软件园下载的汉化水影b2。", "这是我在拼多多9.9买的汉化FDP。还包邮哦", "喜报:Gradle sync started")
    }
