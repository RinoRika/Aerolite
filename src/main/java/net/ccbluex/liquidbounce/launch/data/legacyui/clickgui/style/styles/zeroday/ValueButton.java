...
import net.ccbluex.liquidbounce.utils.render.GuiRenderUtils;
...
public class ValueButton {
    ...
    public int x;
    public GameFontRenderer ValueFont = Fonts.font35;
    public float y;
    ...
    public void render(int mouseX, int mouseY, Window parent) {
        animationY = y;
        int left = Colors.getColor(ColorUtils.INSTANCE.rainbow().getRGB(),150);
        int right = Colors.getColor(ColorUtils.INSTANCE.rainbow(1).getRGB(),150);
        if (value instanceof BoolValue){
            ...
            if (((BoolValue) value).get()){
                parent.drawGradientRect(x+106,animationY,x+116,animationY+10,true, ColorUtils.INSTANCE.rainbow().getRGB(),ColorUtils.INSTANCE.rainbow(1).getRGB());
            }else{
        ...
        if (value instanceof IntegerValue){
            ...
            parent.drawGradientRect(posX+(optionInt.getTranslate().getX()-1), animationY+12, posX+(optionInt.getTranslate().getX()+3),animationY+22,true,ColorUtils.INSTANCE.rainbow().getRGB(),ColorUtils.INSTANCE.rainbow(1).getRGB());
        ...
        if (value instanceof ListValue){
            ...
            Fonts.font35.drawString(value.getName(), (float) (x+10), (float) (animationY+2.5),-1);
            Fonts.font35.drawString(((ListValue) value).get(),(float) (x+120-Fonts.font35.getStringWidth(((ListValue) value).get())-20), (float) (animationY+2.5),-1);
            ...
            if (((ListValue) value).openList){
                ...
                for (String value1 : ((ListValue) value).getValues()){
                    Fonts.font35.drawString("n",x+11,listY,ColorUtils.INSTANCE.rainbow().getRGB());
                    Fonts.font35.drawString(value1,(float) (x+28), listY+1,-1);
                    if (value1.equals(((ListValue) value).getValue())){
                        GuiRenderUtils.drawRoundedRect(x+13.2f,listY-0.2F, 8,8,13f,ColorUtils.INSTANCE.rainbow().getRGB(),1f,ColorUtils.INSTANCE.rainbow().getRGB());
                    }
                    listY+=15;
                }
            }
