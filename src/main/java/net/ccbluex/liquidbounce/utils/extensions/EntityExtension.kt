...
import net.ccbluex.liquidbounce.utils.render.RenderUtilsKt
...
val Entity.renderPos: Vector3d
    get() {
        val x = RenderUtilsKt.interpolate(lastTickPosX, posX) - Minecraft.getMinecraft().renderManager.viewerPosX
        val y = RenderUtilsKt.interpolate(lastTickPosY, posY) - Minecraft.getMinecraft().renderManager.viewerPosY
        val z = RenderUtilsKt.interpolate(lastTickPosZ, posZ) - Minecraft.getMinecraft().renderManager.viewerPosZ
