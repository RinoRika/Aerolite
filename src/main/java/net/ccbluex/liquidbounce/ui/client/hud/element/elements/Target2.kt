...
class Target2 : Element() {
    ...
    override fun drawElement(partialTicks: Float): Border? {
        ...
        if (target is EntityPlayer) {
            ...
            RenderUtils.drawGradientSidewaysNormal(36.0, 16.0, width.toDouble(),
                24.0, Color(40,40,40,220).rgb, Color(60,60,60,255).rgb)
            RenderUtils.drawGradientSidewaysNormal(36.0, 16.0, (36.0F + (easingHealth / target.maxHealth) * (width - 36.0F)).toDouble(),
