...
public class Window {
    ...
    private final GameFontRenderer TitleFont = Fonts.font35;
    public float x;
    public float y;
    ...
    public void render(int tick,int mouseX,int mouseY){
        ...
        Stencil.erase(true);
        Stencil.dispose();
        drawGradientRect(x,y,x+125,y+25,false,ColorUtils.INSTANCE.rainbow().getRGB(),ColorUtils.INSTANCE.rainbow().getRGB());
        net.ccbluex.liquidbounce.utils.render.RenderUtils.drawRect(x,y,x+26,y+25,ColorUtils.INSTANCE.rainbow().getRGB());
        net.ccbluex.liquidbounce.utils.render.RenderUtils.drawImage(new ResourceLocation("aerolite/clickgui/zeroday/" + moduleCategory.getDisplayName() + ".png"), (int) (x+pngX), (int) (y+pngY),pngWidth,pngHeight);
    ...
    public void drawGradientRect(double left, double top, double right, double bottom, boolean sideways, int startColor, int endColor) {
        ...
        DrRenderUtils.color(startColor);
        if (sideways) {
            GL11.glVertex2d(left, top);
            GL11.glVertex2d(left, bottom);
            DrRenderUtils.color(endColor);
