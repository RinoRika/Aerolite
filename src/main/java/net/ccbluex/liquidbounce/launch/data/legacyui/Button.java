...
public class Button {
    ...
    //    BlurUtilsOld.INSTANCE.draw(x-40F,y-40F,80f,80f,20f);
        this.yAnimation = RenderUtils.smoothAnimation(this.yAnimation, RenderUtils.isHovering(mouseX, mouseY, this.x-30f, this.y-30f, this.x + 30.0F, this.y + 30.0F) ? 4.0F : 0.0F, 3.0F, 0.4F);
