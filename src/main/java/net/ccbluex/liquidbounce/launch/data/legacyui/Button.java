...
public class Button {
    ...
    public Button(GuiMainMenu parent, int id, String icon, String text, Executor action) {
        this.parent = parent;
        this.buttonID = id;
        this.icon = icon;
        this.text = text;
    ...
    public Button(GuiMainMenu parent, int id, String icon, String text, Executor action, float yOffset) {
        this.parent = parent;
        this.buttonID = id;
        this.icon = icon;
        this.text = text;
    ...
    //    BlurUtils.INSTANCE.draw(x-40F,y-40F,80f,80f,20f);
        this.yAnimation = RenderUtils.smoothAnimation(this.yAnimation, RenderUtils.isHovering(mouseX, mouseY, this.x-30f, this.y-30f, this.x + 30.0F, this.y + 30.0F) ? 4.0F : 0.0F, 120.0F, 0.3F);
