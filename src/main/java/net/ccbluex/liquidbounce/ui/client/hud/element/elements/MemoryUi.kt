...
class MemoryUi(x: Double = 0.0, y: Double = 0.0) : Element(x = x, y = y){
    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        Fonts.font35.drawString("${DpdUtils.usedMemorySize}/${DpdUtils.maxMemorySize}MB",100f-Fonts.font35.getStringWidth("${DpdUtils.usedMemorySize}/${DpdUtils.maxMemorySize}MB"),21.5f,Color(255,255,255).rgb,true)
        Fonts.font35.drawString(decimalFormat.format(DpdUtils.getMemory() * 100).toString() + "%",100f-Fonts.font35.getStringWidth(decimalFormat.format(
            DpdUtils.getMemory() * 100).toString() + "%"),2.5f,Color(255,255,255).rgb,true)
        RenderUtils.drawRect(0f,11f,100f,19f,Color(0,0,0,95))
        RenderUtils.drawRect(0f,11f,100 * DpdUtils.getMemory(),19f,Color(255,255,255,200))
