...
public class Indicators extends Element {
    ...
    public Border drawElement(float partialTicks) {
        ...
        RenderUtils.drawRect(xX + 5, yX + 197 - 405, xX + 100, yX + 198 - 405, mainColor().getRGB());

        Fonts.font35.drawString("Indicators", xX + 37, yX + 202 - 406, -1);
        ...
        this.armorBarWidth = animate(armorWidth, this.armorBarWidth, 0.0229999852180481);
        RenderUtils.drawRect(xX + 44, yX + 210 - 406, xX + 44 + this.armorBarWidth, yX + 213.5 - 406, mainColor().getRGB());

        Fonts.font35.drawString("Armor", xX + 8, yX + 211 - 406, -1);
        ...
        if (timerHelper.hasReached(15L)) {
            this.healthBarWidth = animate(hpWidth, this.healthBarWidth, 0.2029999852180481);
            timerHelper.reset();
        }

        RenderUtils.drawRect(xX + 44, yX + 237 - 406, xX + 44 + this.healthBarWidth, yX + 240.5 - 406, mainColor().getRGB());

        Fonts.font35.drawString("HP", xX + 8, yX + 238 - 406, -1);
