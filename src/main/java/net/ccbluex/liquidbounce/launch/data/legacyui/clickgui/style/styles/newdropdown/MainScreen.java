...
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.newdropdown.impl.ModuleRect;
...
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.newdropdown.utils.normal.Screen;
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.newdropdown.utils.render.DrRenderUtils;
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.newdropdown.utils.render.StencilUtil;
