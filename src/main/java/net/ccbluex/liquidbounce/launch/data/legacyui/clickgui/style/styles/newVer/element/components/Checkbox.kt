...
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.newVer.extensions.animLinear
...
class Checkbox {
    ...
    fun onDraw(x: Float, y: Float, width: Float, height: Float, bgColor: Color, accentColor: Color) {
        ...
        RenderUtils.drawLine(x + width / 2.15, y + width / 4.0 * 3.0, x + width / 3.95F * 3.0, y + width / 3.0, 2F)
